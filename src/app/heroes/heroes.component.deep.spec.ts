...
describe('HeroesComponent (deep tests)', () => {
  ...
  it(`should call heroService.deleteHero when the Hero Component's delete button is clicked Example 1`, () => {
  ...
  it(`should call heroService.deleteHero when the Hero Component's delete button is clicked Example 2`, () => {
    spyOn(fixture.componentInstance, 'delete')
    mockHeroService.getHeroes.and.returnValue(of(HEROES));
  ...
  it(`should call heroService.deleteHero when the Hero Component's delete button is clicked Example 3`, () => {
    spyOn(fixture.componentInstance, 'delete')
    mockHeroService.getHeroes.and.returnValue(of(HEROES));
